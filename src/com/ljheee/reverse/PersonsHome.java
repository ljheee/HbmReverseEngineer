 ...
 * @see com.ljheee.reverse.Persons
...
public class PersonsHome {
	...
	public Persons merge(Persons detachedInstance) {
		...
		try {
			Persons result = (Persons) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Persons findById(java.lang.Integer id) {
		log.debug("getting Persons instance with id: " + id);
		try {
			Persons instance = (Persons) sessionFactory.getCurrentSession().get("com.ljheee.reverse.Persons", id);
			if (instance == null) {
	...
	public List<Persons> findByExample(Persons instance) {
		...
		try {
			List<Persons> results = (List<Persons>) sessionFactory.getCurrentSession()
					.createCriteria("com.ljheee.reverse.Persons").add(create(instance)).list();
